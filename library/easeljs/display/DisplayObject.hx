...
import easeljs.geom.DisplayProps;
...
extern class DisplayObject extends EventDispatcher
{
	 ...
	 */
	function localToGlobal(x:Float, y:Float, ?pt:{ x:Float, y:Float }) : Point;
	 ...
	 */
	function globalToLocal(x:Float, y:Float, ?pt:{ x:Float, y:Float }) : Point;
	 ...
	 */
	function localToLocal(x:Float, y:Float, target:DisplayObject, ?pt:{ x:Float, y:Float }) : Point;
	...
	inline function removeClickEventListener(handler:MouseEvent->Void, ?useCapture:Bool) : Void removeEventListener("click", handler, useCapture);
	/**
	...
	inline function removeAddedEventListener(handler:Dynamic->Void, ?useCapture:Bool) : Void removeEventListener("added", handler, useCapture);
	/**
	...
	inline function removeRemovedEventListener(handler:Dynamic->Void, ?useCapture:Bool) : Void removeEventListener("removed", handler, useCapture);
	/**
	...
	inline function removeTickEventListener(handler:DisplayObjectTickEvent->Void, ?useCapture:Bool) : Void removeEventListener("tick", handler, useCapture);
}