...
extern class Sprite extends DisplayObject
{
	...
	function new(spriteSheet:SpriteSheet, ?frameOrAnimation:Dynamic) : Void;
	...
	inline function removeAnimationendEventListener(handler:SpriteAnimationendEvent->Void, ?useCapture:Bool) : Void removeEventListener("animationend", handler, useCapture);
	/**
	...
	inline function removeChangeEventListener(handler:SpriteChangeEvent->Void, ?useCapture:Bool) : Void removeEventListener("change", handler, useCapture);
}